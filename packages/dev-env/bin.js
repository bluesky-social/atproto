...
// @NOTE This file exists as javascript so that pnpm can properly link the bin
// when the monorepo is being setup (during initial "pnpm install").

require('./dist/env.js')

const { generateMockSetup } = require('./dist/mock.js')
const { TestNetwork } = require('./dist/network.js')
const { mockMailer } = require('./dist/util.js')
