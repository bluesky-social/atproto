...
export async function down(db: Kysely<unknown>): Promise<void> {
  await db.schema.dropTable(likeTable)
  await db.schema.dropTable(repostTable)
  await db.schema.dropTable(postEntityTable)
  await db.schema.dropTable(postTable)
  await db.schema.dropTable(followTable)
  await db.schema.dropTable(badgeAcceptTable)
  await db.schema.dropTable(badgeOfferTable)
  await db.schema.dropTable(badgeTable)
  await db.schema.dropTable(profileBadgeTable)
  await db.schema.dropTable(profileTable)
  await db.schema.dropTable(notificationTable)
  await db.schema.dropTable(inviteUseTable)
  await db.schema.dropTable(inviteTable)
  await db.schema.dropTable(recordTable)
  await db.schema.dropTable(repoRootTable)
  await db.schema.dropTable(userTable)
}
