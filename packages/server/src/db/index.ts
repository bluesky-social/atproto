...
import acceptedBadgePlugin, {
  AppBskyAcceptedBadge,
} from './records/acceptedBadge'
...
export class Database {
  ...
  records: {
    ...
    accpetedBadge: DbRecordPlugin<AcceptedBadge.Record, AppBskyAcceptedBadge>
  }
  ...
  constructor(
    ...
    this.records = {
      ...
      accpetedBadge: acceptedBadgePlugin(db),
