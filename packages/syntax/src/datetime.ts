/**
 * A strictly formatted UTC datetime string (`YYYY-MM-DDTHH:mm:ss.sssZ`) as returned by {@link Date.toISOString}.
 */
...
const DATETIME_REGEX =
  /^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d(.\d{1,20})?(Z|([+-][0-2]\d:[0-5]\d))$/
