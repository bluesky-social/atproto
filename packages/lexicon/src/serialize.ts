...
import { type LexValue, MAX_PAYLOAD_NESTED_LEVELS } from '@atproto/lex-data'
import {
  type DeepTransformOptions,
 ...
 * @internal
 */
const IPLD_TRANSFORM_OPTS: Required<DeepTransformOptions> = Object.freeze({
  strict: false,
