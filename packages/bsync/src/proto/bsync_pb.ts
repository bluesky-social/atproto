...
export class NotifOperation extends Message<NotifOperation> {
  ...
  /**
   * @generated from field: bsync.NotifOperation.Setting setting = 3;
   */
  setting = NotifOperation_Setting.UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "actor_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "setting", kind: "enum", T: proto3.getEnumType(NotifOperation_Setting) },
  ]);
...
/**
 * @generated from enum bsync.NotifOperation.Setting
 */
export enum NotifOperation_Setting {
  /**
  ...
  /**
   * @generated from enum value: SETTING_UNFILTERED = 1;
   */
  UNFILTERED = 1,

  /**
   * @generated from enum value: SETTING_PRIORITY = 2;
   */
  PRIORITY = 2,
}
// Retrieve enum metadata with: proto3.getEnumType(NotifOperation_Setting)
proto3.util.setEnumType(NotifOperation_Setting, "bsync.NotifOperation.Setting", [
  { no: 0, name: "SETTING_UNSPECIFIED" },
  { no: 1, name: "SETTING_UNFILTERED" },
  { no: 2, name: "SETTING_PRIORITY" },
]);
...
export class AddNotifOperationRequest extends Message<AddNotifOperationRequest> {
  ...
  /**
   * @generated from field: bsync.NotifOperation.Setting setting = 2;
   */
  setting = NotifOperation_Setting.UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "setting", kind: "enum", T: proto3.getEnumType(NotifOperation_Setting) },
  ]);
