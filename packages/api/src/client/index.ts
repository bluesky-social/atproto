...
import * as AppBskyEmbedComplexRecord from './types/app/bsky/embed/complexRecord'
...
export * as AppBskyEmbedComplexRecord from './types/app/bsky/embed/complexRecord'
