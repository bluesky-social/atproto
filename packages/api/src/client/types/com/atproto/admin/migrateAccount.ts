...
export class InvalidTargetPdsError extends XRPCError {
  constructor(src: XRPCError) {
    super(src.status, src.error, src.message, src.headers, { cause: src })
  }
}

export class MigrationFailedError extends XRPCError {
  constructor(src: XRPCError) {
    super(src.status, src.error, src.message, src.headers, { cause: src })
  }
}
...
export function toKnownErr(e: any) {
  if (e instanceof XRPCError) {
    ...
    if (e.error === 'InvalidTargetPds') return new InvalidTargetPdsError(e)
    if (e.error === 'MigrationFailed') return new MigrationFailedError(e)
  }
