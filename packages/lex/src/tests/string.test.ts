...
describe('com.example.datetime', () => {
  it('Applies datetime formatting constraint', () => {
    ...
    expect(() =>
      ...
      'Invalid RFC-3339 and ISO-8601 format (datetime did not parse as ISO 8601) at $.datetime (got "bad date")',
    )
  })
})
describe('com.example.uri', () => {
  it('Applies uri formatting constraint', () => {
    ...
    ).toThrow('Invalid uri format at $.uri (got "not a uri")')
  })
})
...
describe('com.example.atIdentifier', () => {
  it('Applies at-identifier formatting constraint', () => {
    ...
    expect(() =>
      ...
      'Invalid DID or handle format (Invalid DID or handle) at $.atIdentifier (got "bad id")',
    )
    expect(() =>
      com.example.atIdentifier.$parse({
        $type: 'com.example.atIdentifier',
      ...
      'Invalid DID or handle format (Invalid DID or handle) at $.atIdentifier (got "-bad-.test")',
    )
  })
})
describe('com.example.nsid', () => {
  it('Applies nsid formatting constraint', () => {
    ...
    ).toThrow('Invalid NSID format at $.nsid (got "bad nsid")')
    expect(() =>
      com.example.nsid.$parse({
        $type: 'com.example.nsid',
        nsid: 'com.bad-.foo',
      }),
    ).toThrow('Invalid NSID format at $.nsid (got "com.bad-.foo")')
  })
})
describe('com.example.cid', () => {
  it('Applies cid formatting constraint', () => {
    ...
    expect(() =>
      ...
      'Invalid CID string format at $.cid (got "abapsdofiuwrpoiasdfuaspdfoiu")',
    )
  })
})
describe('com.example.language', () => {
  it('Applies language formatting constraint', () => {
    ...
    expect(() =>
      ...
      'Invalid BCP 47 language tag format at $.language (got "not-a-language-")',
    )
  })
})
