...
> implements Validator<TInternals['input'], TInternals['output']>
{
   ...
   */
  get $ifMatches() {
    return this.ifMatches.bind(this)
  }
   ...
   */
  get $safeParse() {
    return this.safeParse.bind(this)
  }
   ...
   */
  get $safeValidate() {
    return this.safeValidate.bind(this)
  }
}
