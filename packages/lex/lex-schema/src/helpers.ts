...
export type Foo = InferMethodOutput<Procedure>
export type Po = Procedure['output']
export type AA = InferPayload<Procedure['output'], BinaryData>
export type Foo2 = InferMethodOutput<Query>
export type Foo1 = InferMethodOutput<Query | Procedure>
...
> = M extends Subscription ? LexValue & InferOutput<M['message']> : undefined
