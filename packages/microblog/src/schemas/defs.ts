...
export const embeddedMediaRecord = {
  $type: 'adxs-record',
  author: 'blueskyweb.xyz',
  name: 'EmbeddedMedia',
  ...
  response: {
    ...
    properties: {
      ...
      likedBy: {
        ...
        items: {
          type: 'object',
          required: ['did', 'name', 'displayName', 'indexedAt'],
          properties: {
            did: {
              type: 'string',
            },
...
export const userFollowersView = {
  ...
  reads: ['blueskyweb.xyz:SocialGraph'],
  parameters: {
    type: 'object',
    required: ['user'],
    properties: {
...
export const schemas = [...recordSchemas, ...collectionSchemas, ...viewSchemas]
