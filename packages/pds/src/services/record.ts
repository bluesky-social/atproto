...
import * as Declaration from '../db/records/declaration'
import * as Post from '../db/records/post'
import * as Vote from '../db/records/vote'
import * as Repost from '../db/records/repost'
import * as Trend from '../db/records/trend'
import * as Follow from '../db/records/follow'
import * as Assertion from '../db/records/assertion'
import * as Confirmation from '../db/records/confirmation'
import * as Profile from '../db/records/profile'
