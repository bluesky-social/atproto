    ...
    defs: {
      ...
      accountStats: {
        ...
        properties: {
          ...
          labels: {
            description: 'List of labels currently applied on the account',
            type: 'array',
            items: {
              type: 'string',
            },
      ...
      recordsStats: {
        ...
        properties: {
          subjectCount: {
            description: 'Total number of record subjects in the set',
            type: 'integer',
          },
          pendingCount: {
            description:
          ...
          takendownCount: {
            description: 'Number of record subjects currently taken down',
            type: 'integer',
          },
          labeledCount: {
            description:
