...
import { AcceptView } from './accept/accept-view'
import { ResetPasswordView } from './reset-password/reset-password-view'
import { SignInView } from './sign-in/sign-in-view'
import { SignUpView } from './sign-up/sign-up-view'
...
export function AuthorizeView({
  ...
  if (view === View.Done) {
    return (
      <LayoutTitlePage {...props} title="Login complete">
