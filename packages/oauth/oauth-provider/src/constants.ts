...
/** @see {@link CONFIDENTIAL_CLIENT_SESSION_LIFETIME} */
export const FIRST_PARTY_CLIENT_SESSION_LIFETIME =
  CONFIDENTIAL_CLIENT_SESSION_LIFETIME

/** @see {@link CONFIDENTIAL_CLIENT_REFRESH_LIFETIME} */
export const FIRST_PARTY_CLIENT_REFRESH_LIFETIME =
