...
export const oauthAuthorizationServerMetadataSchema = z.object({
  ...
  authorization_endpoint: webUrlSchema, // .optional(),

  token_endpoint: webUrlSchema, // .optional(),
  token_endpoint_auth_methods_supported: z.array(z.string()).optional(),
  token_endpoint_auth_signing_alg_values_supported: z
    .array(z.string())
    .optional(),

  revocation_endpoint: webUrlSchema.optional(),
  introspection_endpoint: webUrlSchema.optional(),
  pushed_authorization_request_endpoint: webUrlSchema.optional(),

  require_pushed_authorization_requests: z.boolean().optional(),

  userinfo_endpoint: webUrlSchema.optional(),
  end_session_endpoint: webUrlSchema.optional(),
  registration_endpoint: webUrlSchema.optional(),

  // https://datatracker.ietf.org/doc/html/rfc9449#section-5.1
  dpop_signing_alg_values_supported: z.array(z.string()).optional(),

  // https://datatracker.ietf.org/doc/html/draft-ietf-oauth-resource-metadata-05#section-4
  protected_resources: z.array(webUrlSchema).optional(),
