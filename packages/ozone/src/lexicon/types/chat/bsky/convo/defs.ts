...
export function isLogBeginConvo(
  v: unknown,
): v is LogBeginConvo & {
...
export function isLogLeaveConvo(
  v: unknown,
): v is LogLeaveConvo & {
...
export function isLogDeleteMessage(
  v: unknown,
): v is LogDeleteMessage & {
