...
export async function up(db: Kysely<unknown>): Promise<void> {
  await sql`
    ...
    ON moderation_event("createdBy","subjectDid") 
  ...
  await sql`
    ...
    ON moderation_event("createdBy","subjectDid","subjectUri") 
  ...
  await sql`
    ...
    ON moderation_event("subjectDid","action") 
    WHERE "subjectUri" IS NULL 
  ...
  await sql`
    ...
    ON moderation_event("subjectDid","subjectUri", "action") 
    WHERE "subjectUri" IS NOT NULL 
    AND "action" IN ( 'tools.ozone.moderation.defs#modEventTakedown', 'tools.ozone.moderation.defs#modEventLabel')
  `.execute(db)
}
