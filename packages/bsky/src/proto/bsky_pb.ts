...
/**
 * @generated from message bsky.GetSuggestedStarterPacksRequest
 */
export class GetSuggestedStarterPacksRequest extends Message<GetSuggestedStarterPacksRequest> {
  /**
   * @generated from field: string actor_did = 1;
   */
  actorDid = "";
  ...
  constructor(data?: PartialMessage<GetSuggestedStarterPacksRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetSuggestedStarterPacksRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "actor_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "limit", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetSuggestedStarterPacksRequest {
    return new GetSuggestedStarterPacksRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetSuggestedStarterPacksRequest {
    return new GetSuggestedStarterPacksRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetSuggestedStarterPacksRequest {
    return new GetSuggestedStarterPacksRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetSuggestedStarterPacksRequest | PlainMessage<GetSuggestedStarterPacksRequest> | undefined, b: GetSuggestedStarterPacksRequest | PlainMessage<GetSuggestedStarterPacksRequest> | undefined): boolean {
    return proto3.util.equals(GetSuggestedStarterPacksRequest, a, b);
  }
}

/**
 * @generated from message bsky.GetSuggestedStarterPacksResponse
 */
export class GetSuggestedStarterPacksResponse extends Message<GetSuggestedStarterPacksResponse> {
  /**
   * @generated from field: repeated string uris = 1;
   */
  uris: string[] = [];
  ...
  constructor(data?: PartialMessage<GetSuggestedStarterPacksResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetSuggestedStarterPacksResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uris", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 2, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetSuggestedStarterPacksResponse {
    return new GetSuggestedStarterPacksResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetSuggestedStarterPacksResponse {
    return new GetSuggestedStarterPacksResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetSuggestedStarterPacksResponse {
    return new GetSuggestedStarterPacksResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetSuggestedStarterPacksResponse | PlainMessage<GetSuggestedStarterPacksResponse> | undefined, b: GetSuggestedStarterPacksResponse | PlainMessage<GetSuggestedStarterPacksResponse> | undefined): boolean {
    return proto3.util.equals(GetSuggestedStarterPacksResponse, a, b);
  }
}
