...
/**
 * @generated from message bsky.PollAnswerCount
 */
export class PollAnswerCount extends Message<PollAnswerCount> {
  /**
   * @generated from field: repeated int32 count = 3;
   */
  count: number[] = [];

  constructor(data?: PartialMessage<PollAnswerCount>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.PollAnswerCount";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 3, name: "count", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PollAnswerCount {
    return new PollAnswerCount().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PollAnswerCount {
    return new PollAnswerCount().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PollAnswerCount {
    return new PollAnswerCount().fromJsonString(jsonString, options);
  }

  static equals(a: PollAnswerCount | PlainMessage<PollAnswerCount> | undefined, b: PollAnswerCount | PlainMessage<PollAnswerCount> | undefined): boolean {
    return proto3.util.equals(PollAnswerCount, a, b);
  }
}
...
export class GetInteractionCountsResponse extends Message<GetInteractionCountsResponse> {
  ...
  /**
   * @generated from field: repeated int32 poll_answer_count = 5;
   */
  pollAnswerCount: number[] = [];

  /**
   * @generated from field: repeated bsky.PollAnswerCount poll_answers = 6;
   */
  pollAnswers: PollAnswerCount[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "poll_answer_count", kind: "scalar", T: 5 /* ScalarType.INT32 */, repeated: true },
    { no: 6, name: "poll_answers", kind: "message", T: PollAnswerCount, repeated: true },
  ]);
