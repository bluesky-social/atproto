...
export class FilterableNotificationPreference extends Message<FilterableNotificationPreference> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "filter", kind: "enum", T: proto3.getEnumType(NotificationFilter) },
...
export class ChatNotificationPreference extends Message<ChatNotificationPreference> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "filter", kind: "enum", T: proto3.getEnumType(ChatNotificationFilter) },
    { no: 2, name: "push", kind: "message", T: NotificationChannelPush },
  ]);
...
export class GetAgeAssuranceStateRequest extends Message<GetAgeAssuranceStateRequest> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetAgeAssuranceStateRequest {
    return new GetAgeAssuranceStateRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetAgeAssuranceStateRequest {
    return new GetAgeAssuranceStateRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetAgeAssuranceStateRequest {
    return new GetAgeAssuranceStateRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetAgeAssuranceStateRequest | PlainMessage<GetAgeAssuranceStateRequest> | undefined, b: GetAgeAssuranceStateRequest | PlainMessage<GetAgeAssuranceStateRequest> | undefined): boolean {
...
export class GetAgeAssuranceStateResponse extends Message<GetAgeAssuranceStateResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "status", kind: "enum", T: proto3.getEnumType(AgeAssuranceStatus) },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetAgeAssuranceStateResponse {
    return new GetAgeAssuranceStateResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetAgeAssuranceStateResponse {
    return new GetAgeAssuranceStateResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetAgeAssuranceStateResponse {
    return new GetAgeAssuranceStateResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetAgeAssuranceStateResponse | PlainMessage<GetAgeAssuranceStateResponse> | undefined, b: GetAgeAssuranceStateResponse | PlainMessage<GetAgeAssuranceStateResponse> | undefined): boolean {
