...
export class NotificationPreferences extends Message<NotificationPreferences> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "follow", kind: "message", T: FilterableNotificationPreference },
    { no: 3, name: "like", kind: "message", T: FilterableNotificationPreference },
    { no: 4, name: "like_via_repost", kind: "message", T: FilterableNotificationPreference },
    { no: 5, name: "mention", kind: "message", T: FilterableNotificationPreference },
    { no: 6, name: "quote", kind: "message", T: FilterableNotificationPreference },
    { no: 7, name: "reply", kind: "message", T: FilterableNotificationPreference },
    { no: 8, name: "repost", kind: "message", T: FilterableNotificationPreference },
    { no: 9, name: "repost_via_repost", kind: "message", T: FilterableNotificationPreference },
    { no: 10, name: "starterpack_joined", kind: "message", T: NotificationPreference },
    { no: 11, name: "subscribed_post", kind: "message", T: NotificationPreference },
