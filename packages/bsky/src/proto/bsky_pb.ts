...
/**
 * @generated from message bsky.VerificationData
 */
export class VerificationData extends Message<VerificationData> {
  /**
  ...
  constructor(data?: PartialMessage<VerificationData>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.VerificationData";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "handle", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "displayName", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): VerificationData {
    return new VerificationData().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): VerificationData {
    return new VerificationData().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): VerificationData {
    return new VerificationData().fromJsonString(jsonString, options);
  }

  static equals(a: VerificationData | PlainMessage<VerificationData> | undefined, b: VerificationData | PlainMessage<VerificationData> | undefined): boolean {
    return proto3.util.equals(VerificationData, a, b);
  }
}
...
export class ActorInfo extends Message<ActorInfo> {
  ...
  /**
   * @generated from field: bool trusted_voucher = 13;
   */
  trustedVoucher = false;

  /**
   * @generated from field: map<string, bsky.VerificationData> verified_by = 14;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 13, name: "trusted_voucher", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 14, name: "verified_by", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "message", T: VerificationData} },
  ]);
...
export class VouchInfo extends Message<VouchInfo> {
  ...
  /**
   * @generated from field: string issuer_did = 2;
   */
  issuerDid = "";

  /**
   * @generated from field: string receiver_did = 3;
   */
  receiverDid = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uri", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "issuer_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "receiver_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): VouchInfo {
    return new VouchInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): VouchInfo {
    return new VouchInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): VouchInfo {
    return new VouchInfo().fromJsonString(jsonString, options);
  }

  static equals(a: VouchInfo | PlainMessage<VouchInfo> | undefined, b: VouchInfo | PlainMessage<VouchInfo> | undefined): boolean {
    return proto3.util.equals(VouchInfo, a, b);
  }
}

/**
 * @generated from message bsky.GetVouchesIssuedRequest
 */
export class GetVouchesIssuedRequest extends Message<GetVouchesIssuedRequest> {
  /**
   * @generated from field: string issuer_did = 1;
   */
  issuerDid = "";
  ...
  constructor(data?: PartialMessage<GetVouchesIssuedRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetVouchesIssuedRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "issuer_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "limit", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchesIssuedRequest {
    return new GetVouchesIssuedRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchesIssuedRequest {
    return new GetVouchesIssuedRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchesIssuedRequest {
    return new GetVouchesIssuedRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchesIssuedRequest | PlainMessage<GetVouchesIssuedRequest> | undefined, b: GetVouchesIssuedRequest | PlainMessage<GetVouchesIssuedRequest> | undefined): boolean {
    return proto3.util.equals(GetVouchesIssuedRequest, a, b);
  }
}

/**
 * @generated from message bsky.GetVouchesIssuedResponse
 */
export class GetVouchesIssuedResponse extends Message<GetVouchesIssuedResponse> {
  /**
  ...
  constructor(data?: PartialMessage<GetVouchesIssuedResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetVouchesIssuedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "vouches", kind: "message", T: VouchInfo, repeated: true },
    { no: 2, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchesIssuedResponse {
    return new GetVouchesIssuedResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchesIssuedResponse {
    return new GetVouchesIssuedResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchesIssuedResponse {
    return new GetVouchesIssuedResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchesIssuedResponse | PlainMessage<GetVouchesIssuedResponse> | undefined, b: GetVouchesIssuedResponse | PlainMessage<GetVouchesIssuedResponse> | undefined): boolean {
    return proto3.util.equals(GetVouchesIssuedResponse, a, b);
  }
}
...
export class GetVouchesReceivedRequest extends Message<GetVouchesReceivedRequest> {
  /**
   * @generated from field: string receiver_did = 1;
   */
  receiverDid = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "receiver_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "limit", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchesReceivedRequest {
    return new GetVouchesReceivedRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchesReceivedRequest {
    return new GetVouchesReceivedRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchesReceivedRequest {
    return new GetVouchesReceivedRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchesReceivedRequest | PlainMessage<GetVouchesReceivedRequest> | undefined, b: GetVouchesReceivedRequest | PlainMessage<GetVouchesReceivedRequest> | undefined): boolean {
...
export class GetVouchesReceivedResponse extends Message<GetVouchesReceivedResponse> {
  /**
   * @generated from field: repeated bsky.VouchInfo vouchers = 1;
   */
  vouchers: VouchInfo[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "vouchers", kind: "message", T: VouchInfo, repeated: true },
    { no: 2, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchesReceivedResponse {
    return new GetVouchesReceivedResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchesReceivedResponse {
    return new GetVouchesReceivedResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchesReceivedResponse {
    return new GetVouchesReceivedResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchesReceivedResponse | PlainMessage<GetVouchesReceivedResponse> | undefined, b: GetVouchesReceivedResponse | PlainMessage<GetVouchesReceivedResponse> | undefined): boolean {
    return proto3.util.equals(GetVouchesReceivedResponse, a, b);
  }
}

/**
 * @generated from message bsky.GetKnownVouchesReceivedRequest
 */
export class GetKnownVouchesReceivedRequest extends Message<GetKnownVouchesReceivedRequest> {
  /**
  ...
  /**
   * @generated from field: string receiver_did = 2;
   */
  receiverDid = "";

  constructor(data?: PartialMessage<GetKnownVouchesReceivedRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetKnownVouchesReceivedRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "viewer_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "receiver_did", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetKnownVouchesReceivedRequest {
    return new GetKnownVouchesReceivedRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetKnownVouchesReceivedRequest {
    return new GetKnownVouchesReceivedRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetKnownVouchesReceivedRequest {
    return new GetKnownVouchesReceivedRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetKnownVouchesReceivedRequest | PlainMessage<GetKnownVouchesReceivedRequest> | undefined, b: GetKnownVouchesReceivedRequest | PlainMessage<GetKnownVouchesReceivedRequest> | undefined): boolean {
    return proto3.util.equals(GetKnownVouchesReceivedRequest, a, b);
  }
}

/**
 * @generated from message bsky.GetKnownVouchesReceivedResponse
 */
export class GetKnownVouchesReceivedResponse extends Message<GetKnownVouchesReceivedResponse> {
  /**
   * @generated from field: repeated bsky.VouchInfo vouchers = 1;
   */
  vouchers: VouchInfo[] = [];
  ...
  constructor(data?: PartialMessage<GetKnownVouchesReceivedResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bsky.GetKnownVouchesReceivedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "vouchers", kind: "message", T: VouchInfo, repeated: true },
    { no: 2, name: "cursor", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetKnownVouchesReceivedResponse {
    return new GetKnownVouchesReceivedResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetKnownVouchesReceivedResponse {
    return new GetKnownVouchesReceivedResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetKnownVouchesReceivedResponse {
    return new GetKnownVouchesReceivedResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetKnownVouchesReceivedResponse | PlainMessage<GetKnownVouchesReceivedResponse> | undefined, b: GetKnownVouchesReceivedResponse | PlainMessage<GetKnownVouchesReceivedResponse> | undefined): boolean {
    return proto3.util.equals(GetKnownVouchesReceivedResponse, a, b);
  }
}
