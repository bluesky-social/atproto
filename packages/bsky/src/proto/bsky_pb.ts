...
export class GetBookmarksByActorAndKeysRequest extends Message<GetBookmarksByActorAndKeysRequest> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetBookmarksByActorAndKeysRequest {
    return new GetBookmarksByActorAndKeysRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetBookmarksByActorAndKeysRequest {
    return new GetBookmarksByActorAndKeysRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetBookmarksByActorAndKeysRequest {
    return new GetBookmarksByActorAndKeysRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetBookmarksByActorAndKeysRequest | PlainMessage<GetBookmarksByActorAndKeysRequest> | undefined, b: GetBookmarksByActorAndKeysRequest | PlainMessage<GetBookmarksByActorAndKeysRequest> | undefined): boolean {
...
export class GetBookmarksByActorAndKeysResponse extends Message<GetBookmarksByActorAndKeysResponse> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetBookmarksByActorAndKeysResponse {
    return new GetBookmarksByActorAndKeysResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetBookmarksByActorAndKeysResponse {
    return new GetBookmarksByActorAndKeysResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetBookmarksByActorAndKeysResponse {
    return new GetBookmarksByActorAndKeysResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetBookmarksByActorAndKeysResponse | PlainMessage<GetBookmarksByActorAndKeysResponse> | undefined, b: GetBookmarksByActorAndKeysResponse | PlainMessage<GetBookmarksByActorAndKeysResponse> | undefined): boolean {
