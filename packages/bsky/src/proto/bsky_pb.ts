...
export class GetVouchRecordsRequest extends Message<GetVouchRecordsRequest> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchRecordsRequest {
    return new GetVouchRecordsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchRecordsRequest {
    return new GetVouchRecordsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchRecordsRequest {
    return new GetVouchRecordsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchRecordsRequest | PlainMessage<GetVouchRecordsRequest> | undefined, b: GetVouchRecordsRequest | PlainMessage<GetVouchRecordsRequest> | undefined): boolean {
...
export class GetVouchRecordsResponse extends Message<GetVouchRecordsResponse> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetVouchRecordsResponse {
    return new GetVouchRecordsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetVouchRecordsResponse {
    return new GetVouchRecordsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetVouchRecordsResponse {
    return new GetVouchRecordsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GetVouchRecordsResponse | PlainMessage<GetVouchRecordsResponse> | undefined, b: GetVouchRecordsResponse | PlainMessage<GetVouchRecordsResponse> | undefined): boolean {
