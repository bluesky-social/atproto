...
export const Service = {
  ...
  methods: {
    ...
    /**
     * Returns how many drafts a user has.
     *
     * @generated from rpc bsky.Service.CountActorDrafts
     */
    countActorDrafts: {
      name: "CountActorDrafts",
      I: CountActorDraftsRequest,
      O: CountActorDraftsResponse,
      kind: MethodKind.Unary,
    },
    /**
     * Identity
