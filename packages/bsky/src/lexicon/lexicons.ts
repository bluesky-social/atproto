...
export const schemaDict = {
  ...
  AppBskyDraftGetDrafts: {
    ...
    defs: {
      main: {
        type: 'query',
        description:
          'Gets all user drafts. No pagination is allowed since the number of drafts is limited to 100. Requires authentication.',
        parameters: {
          type: 'params',
          properties: {},
        },
  ...
  AppBskyDraftPutDraft: {
    lexicon: 1,
    id: 'app.bsky.draft.putDraft',
    defs: {
      main: {
        type: 'procedure',
        description:
          'Upserts a draft using private storage (stash). Requires authentication.',
        input: {
          encoding: 'application/json',
          schema: {
            type: 'object',
...
export const ids = {
  ...
  AppBskyDraftPutDraft: 'app.bsky.draft.putDraft',
