...
Don't hand-fix mechanical lint violations (e.g. `import type` / `verbatimModuleSyntax`, import ordering) — run `pnpm lint:fix` and let it apply them.
