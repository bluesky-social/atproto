...
| `@atproto/lex`: modern type-safe client library with codegen                  | [README](./packages/lex/README.md)         | [![NPM](https://img.shields.io/npm/v/@atproto/lex)](https://www.npmjs.com/package/@atproto/lex)       |
