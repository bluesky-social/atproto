...
const SECRET_KEY =
  "I0HyDksQcCRdJBGVuE78Ts34SzyF7+xNprEQw/IRa51OuFZQc5ugqfgjeWRMehyfr7A1vXICRoUD5kqVadsRHA==";
...
app.post("/post", async (req, res) => {
  ...
  const userStore = await UserStore.fromCarFile(
    car,
    res.locals.blockstore,
    SERVER_KEYPAIR
  );
